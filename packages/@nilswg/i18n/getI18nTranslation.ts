 ...
 */
export function getI18nTextArray(t: TFunction, i18nKey: string | string[]): string[] {
 ...
 */
export function getI18nObjects<T>(t: Function, i18nKey: string | string[]): T[] {
    const results = t(i18nKey, { returnObjects: true });
    return isObjectArray<T>(results) ? results : [];
}
