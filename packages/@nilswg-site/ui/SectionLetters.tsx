...
export const SectionText: FC<Props_SectionText> = ({ lang, children }) => {
    return (
        <>
...
export const SectionTitle: FC<Props_SectionTitle> = ({ lang, text }) => {
    return (
        <>
            <DecTag className="ml-6 pt-10">{'<h1>'}</DecTag>
            <LettersZone
                className={cn(
                    lang === 'zh-TW' ? 'font-notosans_bold mb-3' : 'font-russon font-normal',
