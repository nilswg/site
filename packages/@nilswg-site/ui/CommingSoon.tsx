...
export const CommingSoonTexts: FC<{
    texts: {
    ...
    return (
        <Fragment>
            <p className="mt-8 text-4xl font-bold capitalize tracking-wide text-orange-500">{texts.underConstructionText}!</p>
            <p className="mt-4 text-xl uppercase text-orange-500">{texts.comingSoonText}!</p>
        </Fragment>
    );
};
...
export const CommingSoon: FC<{ children: ReactNode }> = ({ children }) => (
    <>
        <div className="flex h-[calc(100vh-5rem)] w-full flex-col items-center justify-center pb-[5rem]">
            <div className="w-3/4">
                <svg
                    ...
                    <path
                        ...
                        transform="translate(-127.5 -158.38785)"
                        fill="#3f3d56"></path>
                    <polygon points="255.504 550.825 267.523 556.976 296.966 513.544 279.228 504.466 255.504 550.825" fill="#ffb7b7"></polygon>
                    <path
                        d="M381.94612,703.72021l23.66983,12.113.001.00049a16.94563,16.94563,0,0,1,7.3641,22.8037l-.25087.49017-38.75427-19.83265Z"
                        transform="translate(-127.5 -158.38785)"
                        fill="#2f2e41"></path>
                    <polygon points="394.317 567.652 407.819 567.652 414.242 515.575 394.315 515.575 394.317 567.652" fill="#ffb7b7"></polygon>
                    <path
                    ...
                    <path
                        ...
                        transform="translate(-127.5 -158.38785)"
                        fill="#2f2e41"></path>
                    <polygon points="429.776 309.458 327.357 302.85 335.066 270.913 428.674 291.838 429.776 309.458" fill="#cbcbcb"></polygon>
                    <path
            ...
            <div className="flex flex-col items-center justify-center px-4 text-center lg:px-0 xl:w-1/2">{children}</div>
        </div>
    </>
);
